    ...
    if (obj->IsA()->InheritsFrom(TDirectory::Class())) {
      ...
      for(Int_t i=0;i<nevents;++i){
        ...
        if (metType == -1) { // -1 = PF Met
          ...
          metcorrJetAbsoluteDown_ey = met_AbsoluteDown*TMath::Sin(metphi_AbsoluteDown);
          metcorrJetAbsoluteUp_ey = met_AbsoluteUp*TMath::Sin(metphi_AbsoluteUp);
          metcorrJetAbsoluteyearDown_ey = met_AbsoluteyearDown*TMath::Sin(metphi_AbsoluteyearDown);
          metcorrJetAbsoluteyearUp_ey = met_AbsoluteyearUp*TMath::Sin(metphi_AbsoluteyearUp);
          metcorrJetBBEC1Down_ey = met_BBEC1Down*TMath::Sin(metphi_BBEC1Down);
          metcorrJetBBEC1Up_ey = met_BBEC1Up*TMath::Sin(metphi_BBEC1Up);
          metcorrJetBBEC1yearDown_ey = met_BBEC1yearDown*TMath::Sin(metphi_BBEC1yearDown);
          metcorrJetBBEC1yearUp_ey = met_BBEC1yearUp*TMath::Sin(metphi_BBEC1yearUp);
          metcorrJetEC2Down_ey = met_EC2Down*TMath::Sin(metphi_EC2Down);
          metcorrJetEC2Up_ey = met_EC2Up*TMath::Sin(metphi_EC2Up);
          metcorrJetEC2yearDown_ey = met_EC2yearDown*TMath::Sin(metphi_EC2yearDown);
          metcorrJetEC2yearUp_ey = met_EC2yearUp*TMath::Sin(metphi_EC2yearUp);
          metcorrJetFlavorQCDDown_ey = met_FlavorQCDDown*TMath::Sin(metphi_FlavorQCDDown);
          metcorrJetFlavorQCDUp_ey = met_FlavorQCDUp*TMath::Sin(metphi_FlavorQCDUp);
          metcorrJetHFDown_ey = met_HFDown*TMath::Sin(metphi_HFDown);
          metcorrJetHFUp_ey = met_HFUp*TMath::Sin(metphi_HFUp);
          metcorrJetHFyearDown_ey = met_HFyearDown*TMath::Sin(metphi_HFyearDown);
          metcorrJetHFyearUp_ey = met_HFyearUp*TMath::Sin(metphi_HFyearUp);
          metcorrJetRelativeBalDown_ey = met_RelativeBalDown*TMath::Sin(metphi_RelativeBalDown);
          metcorrJetRelativeBalUp_ey = met_RelativeBalUp*TMath::Sin(metphi_RelativeBalUp);
          metcorrJetRelativeSampleDown_ey = met_RelativeSampleDown*TMath::Sin(metphi_RelativeSampleDown);
          metcorrJetRelativeSampleUp_ey = met_RelativeSampleUp*TMath::Sin(metphi_RelativeSampleUp);
          metcorrJetResDown_ey = met_ResDown*TMath::Sin(metphi_ResDown);
          metcorrJetResUp_ey = met_ResUp*TMath::Sin(metphi_ResUp);
