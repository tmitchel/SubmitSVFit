...
def mergeSample( sample, channel, ttreePath, originalDir, targetDir ) :
    ...
    for file_ in files :
        ...
        if runningSize > 1500 or runningNumFiles == 500 :
...
if __name__ == '__main__' :
    ...
    if doHTT :
        ...
        originalDir = '/hdfs/store/user/tmitchel/legacy-v6-fixTES/skim/et2017_v1'
        channel = 'etau'
        ttreePath = 'etau_tree'
        ...
        targetDir = '/nfs_scratch/tmitchel/merged_et2017_legacy-v6-fixTES_skim/'
